...
int ptCount = 0, num = 0, total = 0, workers = 0, fCount = 0;

/**
* fullCount : acts as the counter for the number of items in the buffer.
* emptyCount : acts as the counter for empty spaces in the buffer.
...
*/
sem_t fullCount, emptyCount, lock;
...
int main( int argc, char *argv[] ) {
  ...
  sem_init( &fullCount, 0, 0); //Keeps track of the # of points.
  sem_init( &emptyCount, 0, POINT_LIMIT); //Tracks empty slots in buffer.
